            ...
            <div class="col-10 container-fluid">
                <div class="form-check">
                    ...
                    <label class=" fw-bolder text-light" for="gridCheck" required>
                        Acepto 
                        <span data-bs-dismiss="modal" data-bs-toggle="modal" style="cursor:pointer"> 
                            <strong class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" data-bs-toggle="modal" data-bs-target="#term">
...
<div class="modal fade" id="term" tabindex="-2" aria-labelledby="termModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div style="height: 80vh;" class="fw-bolder modal-content bg-dark fw-bolder text-primary">
        ...
        <mfooter class="modal-footer d-flex justify-content-between container-fluid">
            ...
            <div id="mfooter-buttons">
                <button data-bs-dismiss="modal" data-bs-toggle="modal">
                    <span type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#registerM">
                        Vale Registrar me 😁
                    </span>
                </button>
