...
<div class="modal fade" id="registerM" tabindex="-1" aria-labelledby="registerModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form class="fw-bolder modal-content bg-dark fw-bolder text-primary" method="POST" action="controller/userX/reg.php">
        ...
        <mbody class="modal-body d-grid row g-2 position-relative">
            ...
            <div class="col-md-10 container-fluid d-flex">
                ...
                <div class="flex-fill col-6">
                    ...
                    <input type="date" class="form-control bg-secondary" id="per_bith" name="per_bith" required>
                </div>
            ...
            <div class="col-md-10 container-fluid">
                ...
                <input type="tel" class="form-control bg-secondary" id="user_tel" name="user_tel" required>
            ...
            <div class="col-md-10 container-fluid">
                ...
                <input type="email" class="form-control bg-secondary" id="user_ema" name="user_ema" required>
            ...
            <div class="col-md-10 container-fluid">
                ...
                <label for="user_pass" class="fw-bold fw-2 text-light">
                    Contraseña
                </label>
