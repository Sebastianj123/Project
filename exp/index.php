...
<?php
        ...
        $name = $queryUser[0]['per_name'];
        $ape = $queryUser[0]['per_lastname'];
...
<div class="modal-dialog">
    ...
    <form class="fw-bolder modal-content bg-dark fw-bolder text-primary" method="POST" action="controller/user/reg.php">
        ...
        <mheader class="modal-header">
            ...
            <h1 class="modal-title text-info fs-3" id="registerModalLabel">
                Ver Datos De <?php echo '"'.$name.' '. $ape.'"'; ?>
            </h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        ...
        <mbody class="modal-body d-grid row g-2 position-relative">
            ...
            <div class="col-md-10 container-fluid">
                ...
                <input type="text" class="form-control bg-secondary" value="<?php if(strlen($name) > 0) echo $name; else echo 'No existe'; ?>" id="per_name" name="per_name" autofocus required>
            ...
            <div class="col-md-10 container-fluid">
                ...
                <input type="text" class="form-control bg-secondary" id="per_lastname" <?php if(strlen($ape) == 0)  echo $noExiste; else echo 'value="'.$ape.'"'; ?> name="per_lastname" required>
                    ...
                    <select class="p-2 fw-bold fw-2 text-dark btn-primary" id="sex_id" name="sex_id" required>
                        ...
                        <?php
                            for ($i = 0; $i < count($querySex); $i++) :
                                ...
                                $nameSex = $querySex[$i]['sex_name'];
                        ?>
                            <option value="<?php echo $idSex; ?>" 
                            title="<?php echo $nameSex; ?>" <?php if($idSex == $sex_id) echo 'selected'; ?>><?php echo$nameSex; ?></option>
                        <?php
                            endfor;
                        ?>
                    </select>
